<x-app-layout>
    <x-page-heading>
        <x-slot name="pageTitle">{{ __('Blocked Groups') }}</x-slot>
        <a class="hidden lg:flex items-center space-x-1 border px-3 py-1 rounded-lg" href="{{ route('admin.group.index') }}">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="py-4 px-6">
                            <div class="flex space-x-3">
                                ...
                                <a data-tooltip-target="tooltip-unblock-group" href="{{ route('admin.group.unblock', $group->id) }}" class="font-medium text-gray-600 dark:text-gray-500 hover:underline"
                                    onclick="permitAction(event, 'Unblock Group', '{{ route('admin.group.unblock', $group->id) }}')">
                                    ...
                                    <div id="tooltip-unblock-group" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                                        Unblock group
