<aside class="hidden lg:block w-72 fixed h-full left-0 top-0 bg-teal-700" aria-label="Sidebar">
   <div class="overflow-y-auto py-4 px-3">
       <a href="/admin" class="flex items-center pl-2.5 mb-5">
         <span class="self-center text-xl uppercase font-semibold whitespace-nowrap dark:text-white">Alphatribesignals</span>
      </a>
       <ul class="space-y-2">
         <li>
